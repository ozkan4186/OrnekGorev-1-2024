            ...
            <div className="flex flex-col px-7 py-4 items-center relative ">
              ...
              <div className="flex flex-col justify-center -ml-20">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="checkbox1" className="ml-1 text-gray-700">
                    Seçenek 1
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 items-center align-middle text-blue-600 border-gray-300 focus:ring-blue-500"
                  />
                  <label htmlFor="checkbox2" className="ml-1 text-gray-700">
                    Seçenek 2
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 items-center align-middle text-blue-600 border-gray-300 focus:ring-blue-500"
                  />
                  <label htmlFor="checkbox3" className="ml-1 text-gray-700">
                    Seçenek 3
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    name="checkboxGroup"
                    value="option1"
                    className="h-4 w-4 items-center align-middle text-blue-600 border-gray-300 
focus:ring-blue-500"
                  />
                  <label htmlFor="checkbox1" className="ml-1 text-gray-700">
                    Seçenek 1
